...
public class Column	implements Serializable{
	...
	private String baseTableIfSQCol;
	//private boolean isPartOfPrimaryKey;
	private boolean limitDefined;   //added by divya for check constraint
	...
	Vector<String>checkValues = new Vector<String>();
	...
	public Column (Column col){
		...
		this.limitDefined = col.limitDefined;
		this.isUnique = col.isUnique();
		this.references = col.references();
		this.checkValues = col.checkValues ;
	...
	public void setCheckValues(Vector<String> checlValues){
		this.checkValues.addAll(checlValues);
	}

	public Vector<String> getCheckValues(){
	...
	public void setBaseRelation(String tableName){
		this.baseTableIfSQCol = tableName;
	}

	public String getBaseRelation(){
		return this.baseTableIfSQCol;
	}
	...
	public void setLimitDefined(boolean limitDefined){
		this.limitDefined = limitDefined;
	}
	...
	public boolean equals(Object obj) {
		...
		if (isNullable != other.isNullable)
			return false;
		if (limitDefined != other.limitDefined)
			return false;
