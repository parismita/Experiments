...
public class StringConstraint {
	...
	/*
	 * constr = operator (tableName_columnNameCOLID (select O_tableName tupleId))
	 * 'constant'
	 * var1 = tableName_columnNameCOLID (select O_tableName tupleId)
	 * operators: =, <, >, not(=, ~ (LIKE), !~ (NOT LIKE), i~ (ILIKE), !i~ (NOT
	 * ILIKE)
	 */
	public StringConstraint(String constr) {
		...
		// + "(declare-datatypes ((GRADE 0)) (((_GRADE__B) (_GRADE__C) (_GRADE__C_m)
		// (_GRADE__B_m) (_GRADE__B_p2B) (_GRADE__C_p2B) (_GRADE__A_m) (_GRADE__F)
		// (_GRADE__A) (_GRADE__H) (_GRADE__I) (_GRADE__J) (_GRADE__K) (_GRADE__L)
		// (_GRADE__M) (_GRADE__N) (_GRADE__O) (_GRADE__G) (NULL_GRADE_1))))"
		// + "(declare-datatypes ((ID 0)) (((_ID__00128) (_ID__12345) (_ID__19991)
		// (_ID__23121) (_ID__44553) (_ID__45678) (_ID__54321) (_ID__55739) (_ID__70557)
		// (_ID__76543) (_ID__76653) (_ID__98765) (_ID__98988) (_ID__V14) (_ID__V15)
		// (_ID__V16) (_ID__V17) (_ID__V18) (_ID__V19) (_ID__V20) (NULL_ID_1))))\n"
		// + "(declare-datatypes ((COURSE_ID 0)) (((_COURSE_uID__BIO_m301)
		// (_COURSE_uID__CS_m347) (_COURSE_uID__FIN_m201) (_COURSE_uID__CS_m315)
		// (_COURSE_uID__EE_m181) (_COURSE_uID__BIO_m101) (_COURSE_uID__MU_m199)
		// (_COURSE_uID__HIS_m351) (_COURSE_uID__PHY_m101) (_COURSE_uID__CS_m319)
		// (_COURSE_uID__CS_m101) (_COURSE_uID__CS_m190) (_COURSE_uID__V13)
		// (_COURSE_uID__V14) (_COURSE_uID__V15) (_COURSE_uID__V16) (_COURSE_uID__V17)
		// (_COURSE_uID__V18) (_COURSE_uID__V19) (_COURSE_uID__V20)
		// (NULL_COURSE_ID_1))))\n"
		// + "(declare-datatypes ((SEC_ID 0)) (((_SEC_uID__2) (_SEC_uID__1)
		// (_SEC_uID__V3) (_SEC_uID__V4) (_SEC_uID__V5) (_SEC_uID__V6) (_SEC_uID__V7)
		// (_SEC_uID__V8) (_SEC_uID__V9) (_SEC_uID__V10) (_SEC_uID__V11) (_SEC_uID__V12)
		// (_SEC_uID__V13) (_SEC_uID__V14) (_SEC_uID__V15) (_SEC_uID__V16)
		// (_SEC_uID__V17) (_SEC_uID__V18) (_SEC_uID__V19) (_SEC_uID__V20)
		// (NULL_SEC_ID_1))))\n"
		// + "(declare-datatypes ((SEMESTER 0)) (((_SEMESTER__Summer)
		// (_SEMESTER__Spring) (_SEMESTER__Fall) (_SEMESTER__V4) (_SEMESTER__V5)
		// (_SEMESTER__V6) (_SEMESTER__V7) (_SEMESTER__V8) (_SEMESTER__V9)
		// (_SEMESTER__V10) (_SEMESTER__V11) (_SEMESTER__V12) (_SEMESTER__V13)
		// (_SEMESTER__V14) (_SEMESTER__V15) (_SEMESTER__V16) (_SEMESTER__V17)
		// (_SEMESTER__V18) (_SEMESTER__V19) (_SEMESTER__V20) (NULL_SEMESTER_1))))"
		...
		// + "(assert (forall ((year Int)) (= (ISNULL_YEAR year) (or (= year
		// intNullVal)))))\n"
		// + "\n"
		// + ""
		// + "(declare-datatypes ((takes_TupleType 0)) (((takes_TupleType (takes_ID0 ID)
		// (takes_COURSE_ID1 COURSE_ID) (takes_SEC_ID2 SEC_ID) (takes_SEMESTER3
		// SEMESTER) (takes_YEAR4 Int) (takes_GRADE5 GRADE)))))"
		...
		/******* TEST CODE **************/
		if (constr.contains("'")) {
			if (constr.contains("not")) {// constr = not (operator (tableName_columnNameCOLID (select O_tableName
											// tupleId)) 'constant')
			...
			else if (constr.contains("!~") )
				operator = "!~";
			else if (constr.contains("i~"))
				operator = "i~";
			else if (constr.contains("~")) {
				operator = "~";
			} else if (constr.contains("<")) {
		 ...
		 * Does XData support var1 relop var2 where var2 is output of constrained
		 * aggregation?
		 */
		else {
			operator = "=";
	...
	/**
	 * Given a set of constraints on a single variable returns the value satisfying
	 * those constraints
	 * 
	 * @param constraints
	...
	public static Automaton giveAutomatonForConstraints(Vector<StringConstraint> constraints) {
		...
		for (StringConstraint s : constraints) {
			...
			// Added by Biplab
			if (s.operator.equalsIgnoreCase("!=") || s.operator.equalsIgnoreCase("<>")
					|| s.operator.equalsIgnoreCase("/=")) {
